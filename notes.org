...
** do something sane with --verbosity and --terminal-verbosity
** add back a --host option 
** merge cleanup/tidy
** check for the parsing of a config file paramater to set the backup type of a backupdestination
