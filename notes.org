...
** TODO re-organize the use directives
** TODO re-organize the global variables
** TODO re-organize the command line options
...
** make maxinc and maxage be settable in a BackupDestination block, not just in globally or in BackupSet
