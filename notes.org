...
** TODO fix the main "backup" section of the program to do both rdiff-backup and duplicity backups
** TODO create a combined check/cleanup command that does check-dest or cleanup appropriately
