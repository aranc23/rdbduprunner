...
*** DONE I have changed exclude-special-files to exclude-device-files, I guess that makes more sense
    CLOSED: [2009-09-04 Fri 13:39]
...
** TODO in no case is tidy called automatically, maybe add AutoTidy as an option?
** DONE --status is not implemented for rdiff-backup type and will call duplicity in stead
   SCHEDULED: <2009-09-04 Fri> CLOSED: [2009-09-04 Fri 13:38]
** DONE there is a bug in tag creation... it adds a - at the end if you leave the trailing slash on the Path specification
   CLOSED: [2009-09-04 Fri 15:14]
** TODO re-examine all the locking calls and make sure they make sense
** TODO add the ability to use gpg-agent as a command line and config file option
